  ...
  const handleStartVideoCall = async (appointment) => {
    try {
      ...
      setActiveCall({
        ...
        patientName: getPatientInfo(appointment).name,
        doctorId: user.id,
        ...
        <div className="row">
          <div className="col-12">
            <div className="d-flex justify-content-between align-items-center p-3 bg-light">
              <h4 className="mb-0">Video Consultation with {activeCall.patientName}</h4>
              <button 
                className="btn btn-outline-secondary btn-sm"
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <ul className="mb-0">
                        ...
                        <li>Test your camera and microphone beforehand</li>
                        <li>Maintain professional appearance</li>
                        <li>You'll receive a ringing notification when patient calls</li>
                      </ul>
                    </div>
                    <div className="col-md-6">
                      <ul className="mb-0">
                        ...
                        <li>Have emergency contact information ready</li>
                        <li>Follow up with patients after consultation</li>
                        <li>Accept or decline incoming calls promptly</li>
                      </ul>
                    </div>
                  </div>
                </div>
